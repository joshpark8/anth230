...
The family would then \tun{share} their culture with the child by \tun{performing} cultural rituals or traditions \tun{symbolic} of the values of that culture, and the child would \tun{learn} and \tun{integrate} these practices to their own life in order to navigate the society in which they live, perhaps \tun{adapting} it to fit themselves better along the way.
